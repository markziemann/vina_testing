...
awk 'substr($0,1,6)=="HETATM" && substr($0,18,3)=="WRA" && substr($0,22,1)=="A" {print}' 1J3K.pdb > crystal_ligand_1J3K_A.pdb
...
awk 'substr($0,1,4)=="ATOM" && substr($0,22,1)=="A" {print}' 1J3K.pdb > 1J3K_chainA_clean.pdb
...
$PYTHONSH $PREPRECEPTOR -r 1J3K_chainA_clean.pdb -o 1J3K_chainA_clean.pdbqt
...
$PYTHONSH $PREPLIGAND4 -l ligand_1J3K_A.pdb -o ligand_1J3K_A.pdbqt

## Run docking
vina --config 1J3K_config.txt --out 1J3K_docking.pdbqt --cpu 8

## Convert docking result to PDB
obabel 1J3K_docking.pdbqt -O 1J3K_docking.pdb

## Show docking score
head -30 1J3K_docking.pdbqt
